function [U_exact, RHO_exact, P_exact, M_exact] = transnozzleExact(L, dx)    
...
xvar=dx;
xlength=L/xvar;
data=zeros(xlength,8);%column1-x, column2-S(x), column3=Mach, column4=Press

for x=0:xvar:L
    res=1;
    cnt=cnt+1;
    data(cnt,1)=x;
    Scrit=1.0;%q1 -- 0.8, q2 -- 1.0
